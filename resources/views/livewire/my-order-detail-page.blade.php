                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="54">
                            ...
                            <td class="py-4">Ksh75,000.00</td>
                            <td class="py-4">
                                <span class="text-center w-8">5</span>
                            </td>
                            <td class="py-4">Ksh375,000.00</td>
                        </tr>
                        <!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">Ksh404,999.00</span>
                </div>
