            ...
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input wire:model='county' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('county') border-red-500 @enderror" id="county" type="text">
                                </input>
                                @error('county')
                                    <div class="text-red-500 text-sm">{{ $message }}</div>
                                @enderror
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        ...
                        <li>
                            <input wire:model='payment_method' class="hidden peer" id="hosting-big" type="radio" value="mpesa">
                        ...
                        <li class="py-3 sm:py-4" wire:key="{{ $cart_item['product_id'] }}">
                            <div class="flex items-center">
                                ...
                                <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                    {{ Number::currency($cart_item['total_amount'], 'KES') }}
                                </div>
                            </div>
                        </li>
                        @endforeach
