                    ...
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
                            <div class="flex items-center justify-between">                
                                <!-- Search Bar aligned to the left edge -->
                                <input type="text" wire:model.live="search" placeholder="Search..." class="block w-full p-2 text-base bg-gray-100 border border-gray-300 rounded dark:text-gray-400 dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">

                                 <!-- Spacer to push the select element to the right -->
                                <div class="flex-grow mx-6"></div>
                                ...
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            ...
                                            <span class="text-red-600 line-through text-sm ml-20">{{ Number::currency($product->price_discount, 'KES') }}</span>
                                        </p>
                                    </div>
