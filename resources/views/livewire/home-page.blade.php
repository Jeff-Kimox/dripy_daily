    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Elevate Your Everyday with <span class="text-blue-600">Dripydaily</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Fresh drops daily. Discover the latest in streetwear, sneakers, and style essentials.</p>
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md" src="{{ asset('assets/images/hero.png') }}" alt="Dripydaily">
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Explore the brands that define the drip.
                    From iconic streetwear labels to up-and-coming designers pushing the boundaries,
                    discover the freshest drops and elevate your style game
                </p>
            </div>
        </div>
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    Discover a diverse range of categories that cater to every style. Whether you're into classic streetwear,
                    high-fashion collaborations, or independent labels, you'll find something to elevate your daily drip.
                </p>
            </div>
        </div>
        ...
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        Discover a diverse range of categories that cater to every style. Whether you're into classic streetwear, high-fashion collaborations, or independent labels, you'll find something to elevate your daily drip
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                        ...
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 09, JAN , 2025
                        </p>
                    </div>
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        Absolutely love this piece! The quality is amazing and it fits perfectly. Will definitely be buying more from DrippyDaily.
                    </p>
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                        ...
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 23, DEC , 2024
                        </p>
                    </div>
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        These are even better than I expected! The attention to detail is impressive and they're so comfortable. Worth every penny
                    </p>
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            <ul class="flex items-center justify-start mr-4">
                ...
                <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                    <div class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-gray-700">
                        ...
                        <p class="px-6 text-base font-medium text-gray-600 dark:text-gray-400"> Joined 12, NOV , 2024
                        </p>
                    </div>
                    <p class="px-6 mb-6 text-base text-gray-500 dark:text-gray-400">
                        Fast shipping and amazing product! I received my order quickly and I'm so happy with the quality. Will definitely order again.
                    </p>
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            <ul class="flex items-center justify-start mr-4">
